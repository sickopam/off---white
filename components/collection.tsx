  ...
  return (
    <>
      <div className='mb-32'>
        ...
        <div className='flex justify-between text-2xl font-Bookish'>
          <h1>1</h1>
      ...
      <div className='w-[80%] mb-52'>
        ...
        <div className='flex flex-row space-x-5  font-Bookish'>
          <div className='w-[62%]'>
      ...
      <div className='w-[75%]'>
        ...
        <div className='flex flex-row space-x-5 mb-44 font-Bookish'>
          {shoes.map((items, i) => (
